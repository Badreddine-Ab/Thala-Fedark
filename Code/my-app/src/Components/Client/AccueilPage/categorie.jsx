import  delivery  from "../../../images/icons/money-back.svg";
import MyImage from '../../../images/icons/delivery.svg';
     ...
     <div className="container py-16">
        <div className="w-10/12 grid grid-cols-3 gap-6 mx-auto justify-center">
            <div className="border border-primary rounded-sm px-3 py-6 flex justify-center items-center gap-5">
                <img src={MyImage} alt="Delivery" className="w-12 h-12 object-contain" />
                <div>
