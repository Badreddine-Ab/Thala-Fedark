...
export default function Product() {
    return (
        ...
        <h2 className="text-2xl font-medium text-gray-800 uppercase mb-6">New Arrivals</h2>
        <div className="grid grid-cols-4 gap-6">
            <div className="bg-white shadow rounded overflow-hidden group">
                <div className="relative">
                    <img src="https://files.fm/thumb_show.php?i=j3evvsqm9" alt="product 1" className="w-full" />
